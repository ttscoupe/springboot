...
- 在线演示 ：  [http://boot.ttscoupe.org](http://boot.ttscoupe.org)

- 在线文档：  [http://doc.ttscoupe.com/1273753](http://doc.ttscoupe.com/1273753)

- 常见问题：  [入门常见问题大全](http://www.ttscoupe.org/forum.php?mod=viewthread&tid=7816&extra=page%3D1)
...
```
	...
	public Result<IPage<TtscoupeDemo>> list(TtscoupeDemo ttscoupeDemo, @RequestParam(name = "pageNo", defaultValue = "1") Integer pageNo, 
	                                     @RequestParam(name = "pageSize", defaultValue = "10") Integer pageSize,
			HttpServletRequest req) {
		Result<IPage<TtscoupeDemo>> result = new Result<IPage<TtscoupeDemo>>();
...
> 功能说明：   一键生成的代码（包括：controller、service、dao、mapper、entity、vue）
 ...
 - 模板位置： src/main/resources/ttscoupe/code-template
 - 技术文档： http://doc.ttscoupe.com
