package org.ttscoupe.common.util;
...
//			org.ttscoupeframework.core.util.LogUtil.info(after_code);
//			org.ttscoupeframework.core.util.LogUtil.info(after_code_zimu);
//			org.ttscoupeframework.core.util.LogUtil.info(after_code_num);
...
//			return parentCode + getNextYouBianCode(localCode);
	...
	public static void main(String[] args) {
		// org.ttscoupeframework.core.util.LogUtil.info(getNextZiMu('C'));
		// org.ttscoupeframework.core.util.LogUtil.info(getNextNum(8));
	    // org.ttscoupeframework.core.util.LogUtil.info(cutYouBianCode("C99A01B01")[2]);
	}
}
