package org.ttscoupe.common.util.jsonschema;
...
public class JsonschemaUtil {
	...
	public static JSONObject getJsonSchema(JsonSchemaDescrip descrip, List<CommonProperty> propertyList) {
		...
		//鬼知道这里为什么报错 org.ttscoupe.modules.system.model.DictModel cannot be cast to org.ttscoupe.modules.system.model.DictModel
