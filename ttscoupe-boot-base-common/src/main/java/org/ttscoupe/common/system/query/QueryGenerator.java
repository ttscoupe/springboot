package org.ttscoupe.common.system.query;
...
import org.ttscoupe.common.util.SqlInjectionUtil;
...
public class QueryGenerator {
	 ...
	 * <br>错误示例:如QueryWrapper<TtscoupeDemo> queryWrapper = new QueryWrapper<TtscoupeDemo>(ttscoupeDemo);
	 * <br>正确示例:QueryWrapper<TtscoupeDemo> queryWrapper = new QueryWrapper<TtscoupeDemo>();
	...
	public static Map<String, SysPermissionDataRuleModel> getRuleMap() {
		...
		List<SysPermissionDataRuleModel> list =TtscoupeDataAutorUtils.loadDataSearchConditon();
