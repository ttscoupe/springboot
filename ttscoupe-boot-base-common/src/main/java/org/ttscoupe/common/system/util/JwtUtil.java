...
public class JwtUtil {
	 ...
	 * @param request
	 * @return
	 * @throws TtscoupeBootException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws TtscoupeBootException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (oConvertUtils.isEmpty(username)) {
			throw new TtscoupeBootException("未获取到用户");
		}
		return username;
	}
	...
	public static String getUserSystemData(String key,SysUserCacheInfo user) {
		if(user==null) {
			user = TtscoupeDataAutorUtils.loadUserInfo();
		}
		//#{sys_user_code}%
