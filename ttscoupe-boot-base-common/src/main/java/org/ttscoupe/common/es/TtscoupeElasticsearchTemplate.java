package org.ttscoupe.common.es;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import lombok.extern.slf4j.Slf4j;
import org.apache.commons.lang.StringUtils;
import org.ttscoupe.common.util.RestUtil;
...
@Slf4j
@Component
public class TtscoupeElasticsearchTemplate {
    ...
    public TtscoupeElasticsearchTemplate(@Value("${ttscoupe.elasticsearch.cluster-nodes}") String baseUrl) {
        log.debug("TtscoupeElasticsearchTemplate BaseURL：" + baseUrl);
