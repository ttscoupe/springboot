...
function openScanFile(title,token,bizNo,archivesNo){
 	 //var pdfUrl ="http://127.0.0.1:8080/ttscoupe-boot/generic/web/viewer.html?file="+encodeURIComponent("http://127.0.0.1:8080/ttscoupe-boot/test/ttscoupeDemo/getPdfUrl?title="+encodeURI(title));
