 ...
 * 代码生成器入口【一对多】
 * @Author 张代浩
 * @site www.ttscoupe.org
 * 
 */
public class TtscoupeOneToMainUtil {
	...
	public static void main(String[] args) {
		...
		mainTable.setTableName("ttscoupe_order_main");//表名
		...
		po.setTableName("ttscoupe_order_customer");//表名
		...
		*/
		...
		po2.setTableName("ttscoupe_order_ticket");		//表名
