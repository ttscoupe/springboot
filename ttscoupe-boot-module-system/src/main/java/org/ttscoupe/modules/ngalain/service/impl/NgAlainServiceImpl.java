package org.ttscoupe.modules.ngalain.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import org.ttscoupe.common.util.MD5Util;
import org.ttscoupe.common.util.oConvertUtils;
import org.ttscoupe.modules.ngalain.mapper.NgAlainMapper;
import org.ttscoupe.modules.ngalain.service.NgAlainService;
...
public class NgAlainServiceImpl implements NgAlainService {
    ...
    public JSONArray getMenu(String id) throws Exception {
        return getTtscoupeMenu(id);
    }
    @Override
    public JSONArray getTtscoupeMenu(String id) throws Exception {
        ...
        JSONObject ttscoupeMenu = new JSONObject();
        ttscoupeMenu.put("text", "ttscoupe菜单");
        ttscoupeMenu.put("group",true);
        ttscoupeMenu.put("children", menulist);
        JSONArray ttscoupeMenuList=new JSONArray();
        ttscoupeMenuList.add(ttscoupeMenu);
        return ttscoupeMenuList;
    }
