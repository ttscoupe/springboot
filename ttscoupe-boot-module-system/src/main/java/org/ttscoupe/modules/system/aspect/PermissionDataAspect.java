package org.ttscoupe.modules.system.aspect;
...
import org.ttscoupe.common.system.util.TtscoupeDataAutorUtils;
import org.ttscoupe.common.system.util.JwtUtil;
import org.ttscoupe.common.system.vo.SysPermissionDataRuleModel;
import org.ttscoupe.common.system.vo.SysUserCacheInfo;
import org.ttscoupe.common.util.SpringContextUtils;
import org.ttscoupe.common.util.oConvertUtils;
import org.ttscoupe.modules.system.entity.SysPermission;
import org.ttscoupe.modules.system.entity.SysPermissionDataRule;
import org.ttscoupe.modules.system.service.ISysPermissionDataRuleService;
import org.ttscoupe.modules.system.service.ISysPermissionService;
import org.ttscoupe.modules.system.service.ISysUserService;
...
public class PermissionDataAspect {
	...
	@Pointcut("@annotation(org.ttscoupe.common.aspect.annotation.PermissionData)")
	...
	public Object arround(ProceedingJoinPoint point) throws  Throwable{
		...
		if(currentSyspermission!=null && currentSyspermission.size()>0) {
			...
			if(dataRules!=null && dataRules.size()>0) {
				TtscoupeDataAutorUtils.installDataSearchConditon(request, dataRules);
				SysUserCacheInfo userinfo = sysUserService.getCacheUser(username);
				TtscoupeDataAutorUtils.installUserInfo(request, userinfo);
			}
		}
