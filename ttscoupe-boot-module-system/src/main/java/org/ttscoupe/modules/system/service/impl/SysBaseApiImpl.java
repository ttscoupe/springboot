...
import org.ttscoupe.common.constant.DataBaseConstant;
import org.ttscoupe.common.exception.TtscoupeBootException;
import org.ttscoupe.common.system.api.ISysBaseAPI;
import org.ttscoupe.common.system.vo.ComboModel;
import org.ttscoupe.common.system.vo.DictModel;
import org.ttscoupe.common.system.vo.LoginUser;
import org.ttscoupe.common.system.vo.SysDepartModel;
import org.ttscoupe.common.util.IPUtils;
...
import org.ttscoupe.modules.message.websocket.WebSocket;
import org.ttscoupe.modules.system.entity.*;
import org.ttscoupe.modules.system.mapper.*;
import org.ttscoupe.modules.system.service.ISysDepartService;
import org.ttscoupe.modules.system.service.ISysDictService;
...
public class SysBaseApiImpl implements ISysBaseAPI {
    ...
    public String parseTemplateByCode(String templateCode,Map<String, String> map) {
        ...
        if(sysSmsTemplates==null||sysSmsTemplates.size()==0){
            throw new TtscoupeBootException("消息模板不存在，模板编码："+templateCode);
        }
		...
		if("".equals(DB_TYPE)) {
			...
			try {
				...
				if(dbType.indexOf("mysql")>=0) {
					...
					throw new TtscoupeBootException("数据库类型:["+dbType+"]不识别!");
				}
			} catch (Exception e) {
