package org.ttscoupe.modules.system.service.impl;
...
import org.ttscoupe.modules.system.mapper.SysPermissionMapper;
import org.ttscoupe.modules.system.model.TreeModel;
...
public class SysPermissionServiceImpl extends ServiceImpl<SysPermissionMapper, SysPermission> implements ISysPermissionService {
	...
	public void deletePermission(String id) throws TtscoupeBootException {
		SysPermission sysPermission = this.getById(id);
		if(sysPermission==null) {
			throw new TtscoupeBootException("未找到菜单信息");
		}
	...
	public void deletePermissionLogical(String id) throws TtscoupeBootException {
		SysPermission sysPermission = this.getById(id);
		if(sysPermission==null) {
			throw new TtscoupeBootException("未找到菜单信息");
		}
	...
	@Override
	@CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	public void addPermission(SysPermission sysPermission) throws TtscoupeBootException {
		//----------------------------------------------------------------------
		//判断是否是一级菜单，是的话清空父菜单
	...
	@Override
	@CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	public void editPermission(SysPermission sysPermission) throws TtscoupeBootException {
