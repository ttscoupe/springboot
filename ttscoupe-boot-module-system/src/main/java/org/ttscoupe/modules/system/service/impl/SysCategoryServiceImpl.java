...
import org.ttscoupe.common.util.FillRuleUtil;
import org.ttscoupe.common.util.YouBianCodeUtil;
import org.ttscoupe.common.util.oConvertUtils;
import org.ttscoupe.modules.system.entity.SysCategory;
import org.ttscoupe.modules.system.mapper.SysCategoryMapper;
import org.ttscoupe.modules.system.model.TreeSelectModel;
import org.ttscoupe.modules.system.service.ISysCategoryService;
...
public class SysCategoryServiceImpl extends ServiceImpl<SysCategoryMapper, SysCategory> implements ISysCategoryService {
	...
	@Override
	public List<TreeSelectModel> queryListByCode(String pcode) throws TtscoupeBootException{
		...
		if(oConvertUtils.isNotEmpty(pcode)) {
			...
			if(list==null || list.size() ==0) {
				throw new TtscoupeBootException("该编码【"+pcode+"】不存在，请核实!");
			}
			if(list.size()>1) {
				throw new TtscoupeBootException("该编码【"+pcode+"】存在多个，请核实!");
			}
