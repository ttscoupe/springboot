package org.ttscoupe.modules.quartz.service.impl;
...
import org.ttscoupe.modules.quartz.mapper.QuartzJobMapper;
import org.ttscoupe.modules.quartz.service.IQuartzJobService;
...
public class QuartzJobServiceImpl extends ServiceImpl<QuartzJobMapper, QuartzJob> implements IQuartzJobService {
	...
	private void schedulerAdd(String jobClassName, String cronExpression, String parameter) {
		try {
			...
			throw new TtscoupeBootException("创建定时任务失败", e);
		} catch (RuntimeException e) {
			throw new TtscoupeBootException(e.getMessage(), e);
		}catch (Exception e) {
			throw new TtscoupeBootException("后台找不到该类名：" + jobClassName, e);
		}
	}
	...
	private void schedulerDelete(String jobClassName) {
		try {
			...
			throw new TtscoupeBootException("删除定时任务失败");
		}
	}
