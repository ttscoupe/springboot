package org.ttscoupe.modules.message.controller;
...
import org.ttscoupe.modules.message.entity.MsgParams;
...
import org.ttscoupe.modules.message.util.PushMsgUtil;
...
public class SysMessageTemplateController extends TtscoupeController<SysMessageTemplate, ISysMessageTemplateService> {
	@Autowired
