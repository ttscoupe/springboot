package org.ttscoupe.modules.message.job;

import java.util.List;

import org.ttscoupe.common.util.DateUtils;
import org.ttscoupe.modules.message.entity.SysMessage;
import org.ttscoupe.modules.message.handle.ISendMsgHandle;
import org.ttscoupe.modules.message.handle.enums.SendMsgStatusEnum;
import org.ttscoupe.modules.message.handle.enums.SendMsgTypeEnum;
...
public class SendMsgJob implements Job {
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		log.info(String.format(" Ttscoupe-Boot 发送消息任务 SendMsgJob !  时间:" + DateUtils.getTimestamp()));
